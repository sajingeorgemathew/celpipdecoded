# CELPIP Decoded Supabase Setup

This document describes how to point the app at the CELPIP Decoded Supabase project and apply the foundation schema from INFRA-01.

## 1. Supabase project

1. Sign in to https://supabase.com with the project account.
2. Create a new project (or open the existing project).
...
Note: the migration filenames (for example `001_academy_foundation.sql`) are kept as-is. This ticket does not rename database objects or migration files.
